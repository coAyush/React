...
const ManagementQuotaBarChart = ({ data }) => {
    return (
       <motion.div
     ...
     <p className="text-lg font-semibold text-slate-700 mb-4">Quota Amounts Received  by Year </p>
...
export default ManagementQuotaBarChart